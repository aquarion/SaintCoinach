...
[SaintCoinach](../README.md), the library for reading **Final Fantasy XIV**
game assets. It reproduces the pipeline the original uses to read data out of
the game's SqPack archives:
